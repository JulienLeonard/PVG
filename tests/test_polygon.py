...
class PolygonTest(unittest.TestCase):
    ...
    def test_points(self):
        ...
        self.assertEqual(square(P0,1.0).coords(),[-0.5,-0.5,-0.5,0.5,0.5,0.5,0.5,-0.5,-0.5,-0.5])
        self.assertEqual(len(square(P0,1.0).points(10)),10)

    def test_segments(self):
        self.assertEqual([seg.coords() for seg in square(P0,1.0).segments()],[(-0.5,-0.5,-0.5,0.5),(-0.5,0.5,0.5,0.5),(0.5,0.5,0.5,-0.5),(0.5,-0.5,-0.5,-0.5)])
    ...
    def test_samples(self):
        self.assertEqual([coord for p in square(P0,1.0).samples(9) for coord in p.coords()],[-0.5,-0.5,-0.5,0.0,-0.5,0.5,0.0,0.5,0.5,0.5,0.5,0.0,0.5,-0.5,0.0,-0.5,-0.5,-0.5])
    ...
    def test_lengths(self):
        self.assertEqual([parange.coords() for parange in square(P0,1.0).paranges()],[[0.0, 0.25, (-0.5, -0.5, -0.5, 0.5)],[0.25, 0.5, (-0.5, 0.5, 0.5, 0.5)],[0.5, 0.75, (0.5, 0.5, 0.5, -0.5)],[0.75, 1.0, (0.5, -0.5, -0.5, -0.5)]])
